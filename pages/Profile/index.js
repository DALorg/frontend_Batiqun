      ...
      <div class="row">
        <div class="col-xl-4 order-xl-2">
          <div class="card card-profile">
            <img src="header.jpg" alt="Image placeholder" class="card-img-top"/>
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="man.png" class="rounded-circle"/>
                  </a>
                </div>
              </div>
            </div>
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <label class="form-control-label" for="input-full-name">Fullname</label>
                        <input
                        type="input"
                        class="form-control"
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-KTP">Upload KTP</label>
                        <input
                        type="file"
                        class="form-control"
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-NIK">NIK/Induk kependudukan</label>
                        <input
                        type="input"
                        class="form-control"
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-tokenID">Token ID</label>
                        <input
                        type="input"
                        class="form-control"
